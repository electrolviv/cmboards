...
void Key4x4::tick() {
    ...
    if(_cnt==0) { setping(GPIO_PIN_4); } else { setpinu(GPIO_PIN_4); }
    if(_cnt==1) { setping(GPIO_PIN_5); } else { setpinu(GPIO_PIN_5); }
    if(_cnt==2) { setping(GPIO_PIN_6); } else { setpinu(GPIO_PIN_6); }
    if(_cnt==3) { setping(GPIO_PIN_7); } else { setpinu(GPIO_PIN_7); }
